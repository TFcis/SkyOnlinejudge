...
{
    public static $url = 'http://tfcis-dev.cf/login/';
    ...
    public static function status()
    {
        ...
        if (@$_GET['logout'] == true) {
            ...
            return (object) ['login' => true, 'data' => $_SESSION['user'], 'url' => 'http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].'?logout=true'];
            ...
            return (object) ['login' => false, 'data' => null, 'url' => self::geturl('login')];
        }
    }
